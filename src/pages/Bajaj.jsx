...
const Bajaj = () => {
  return (
    <div className='bikes-container'>
      <div className='frow'>
        <Bike brand="HONDA" srcName={tvs125} description="Bajaj" link="/honda" />
        <Bike brand="HERO" srcName={rtr310} description="Bajaj" link="/hero" />
        <Bike brand="TVS" srcName={ntorq} description="Bajaj" link="/tvs" />
        <Bike brand="BAJAJ" srcName={rtr160} description="Bajaj" link="/bajaj" />
        <Bike brand="BAJAJ" srcName={jupiter} description="Bajaj" link="/bajaj" />
        <Bike brand="BAJAJ" srcName={sport} description="Bajaj" link="/bajaj" />
        <Bike brand="BAJAJ" srcName={jup125} description="Bajaj" link="/bajaj" />
        <Bike brand="BAJAJ" srcName={comfort} description="Bajaj" link="/bajaj" />
        <Bike brand="BAJAJ" srcName={heavy} description="Bajaj" link="/bajaj" />
        <Bike brand="BAJAJ" srcName={pep} description="Bajaj" link="/bajaj" />
        <Bike brand="BAJAJ" srcName={star} description="Bajaj" link="/bajaj" />
        <Bike brand="BAJAJ" srcName={x} description="Bajaj" link="/bajaj" />
      </div>
    </div>
  );
}
